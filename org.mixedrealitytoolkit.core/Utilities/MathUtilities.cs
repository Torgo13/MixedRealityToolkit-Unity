...
namespace MixedReality.Toolkit
{
    ...
    public static class MathUtilities
    {
        ...
        /// </summary>
        /// <param name="megabytes">Value in megabytes.</param>
        /// <returns>Provided value converted to bytes.</returns>
        public static ulong MegabytesToBytes(float megabytes)
        {
            return ((ulong)megabytes * (ulong)Megabyte);
        }
        ...
        /// <returns>Provided value converted to megabytes.</returns>
